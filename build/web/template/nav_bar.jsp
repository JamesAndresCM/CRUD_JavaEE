<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href='#' data-toggle='modal' data-target='#miModal'>Agregar Mensaje</a></li>
      <%
    ...
    <ul class="nav navbar-nav navbar-right">
      <%
          out.print("<li><a href='#'><span class='glyphicon glyphicon-user'></span>"+session.getAttribute("nombre")+"</a></li>");
